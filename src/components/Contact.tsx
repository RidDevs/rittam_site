          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              ...
              <div className="bg-card/50 border border-border/30 rounded-lg p-6">
                ...
                <p className="text-muted-foreground mb-4">Connect with me on these platforms:</p>
                <div className="flex space-x-4">
                  <a 
                    href="https://www.linkedin.com/in/ridt/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-[#0077B5]/10 hover:bg-[#0077B5]/20 text-[#0077B5] p-3 rounded-full transition-colors"
                    aria-label="LinkedIn"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-[#333]/10 hover:bg-[#333]/20 text-[#333] dark:text-white dark:bg-white/10 dark:hover:bg-white/20 p-3 rounded-full transition-colors"
                    aria-label="GitHub"
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-[#1DA1F2]/10 hover:bg-[#1DA1F2]/20 text-[#1DA1F2] p-3 rounded-full transition-colors"
                    aria-label="Twitter"
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
